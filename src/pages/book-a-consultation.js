    ...
    <Container as="main" sx={{ maxWidth: 1400 }} p={0}>
      ...
      >
        ...
        >
          ...
          are here to help answer all of your questions. let your dreams of the
          perfect engagement ring or jewelry stack become a reality.
        </Text>
        <Box
          mx={3}
          sx={{
      ...
      <Box
        pt={[6, 2]}
        mx="auto"
        sx={{ maxWidth: 830, textAlign: 'center' }}
        mt={6}
      >
